...
export default function SettingsContent({ isUserAdmin }: SettingsContentProps) {
          ...
          <Link href="/settings/users">
            <Card className="p-4 hover:bg-gray-50 transition-colors cursor-pointer">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-medium">Quản lý người dùng</h2>
        ...
        <Link href="/settings/profile">
          <Card className="p-4 hover:bg-gray-50 transition-colors cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-medium">Hồ sơ cá nhân</h2>
                <p className="text-sm text-muted-foreground">
        ...
        <Link href="/settings/database">
          <Card className="p-4 hover:bg-gray-50 transition-colors cursor-pointer">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-medium">Cơ sở dữ liệu</h2>
                <p className="text-sm text-muted-foreground">
